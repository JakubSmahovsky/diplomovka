...
import simpleT.dataStructures.command.CommandOut;
...
public class InjAuthentication extends Query{
  ...
  public InjAuthentication(Principal sender, Principal recipient, Variable sent, Variable received, STModel model) {
    super(model);
    this.sender = sender;
